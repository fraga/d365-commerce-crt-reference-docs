...
- [CreateSalesOrderServiceRequest](../by-request-type/CreateSalesOrderServiceRequest.md)
- [GetNextReceiptIdServiceRequest](../by-request-type/GetNextReceiptIdServiceRequest.md)
- [GenerateOrderNumberServiceRequest](../by-request-type/GenerateOrderNumberServiceRequest.md)
- [SearchSalesTransactionsByReceiptIdServiceRequest](../by-request-type/SearchSalesTransactionsByReceiptIdServiceRequest.md)
- [GetSalesOrderDetailsByTransactionIdServiceRequest](../by-request-type/GetSalesOrderDetailsByTransactionIdServiceRequest.md)
...
- [ValidatePrintReceiptCopyAllowedServiceRequest](../by-request-type/ValidatePrintReceiptCopyAllowedServiceRequest.md)
- [MapSalesOrdersToOperationsRequest](../by-request-type/MapSalesOrdersToOperationsRequest.md)
- [ValidateSalesTransactionServiceRequest](../by-request-type/ValidateSalesTransactionServiceRequest.md)
- [CheckInForOrderPickupServiceRequest](../by-request-type/CheckInForOrderPickupServiceRequest.md)
- [GetOrderHistoryServiceRequest](../by-request-type/GetOrderHistoryServiceRequest.md)
- [GetPurchaseHistoryServiceRequest](../by-request-type/GetPurchaseHistoryServiceRequest.md)
...
- Microsoft.Dynamics.Commerce.Runtime.Localization.Services.SaudiArabia.Triggers.CreateSalesOrderServiceRequestTrigger (Microsoft.Dynamics.Commerce.Runtime.Localization.Services.dll)
- Microsoft.Dynamics.Commerce.Runtime.Localization.Services.Russia.CreateSalesOrderServiceRequestTrigger (Microsoft.Dynamics.Commerce.Runtime.Localization.Services.dll)
- Microsoft.Dynamics.Commerce.Runtime.Localization.Services.Poland.TaxRegistrationId.Triggers.CreateSalesOrderServiceRequestTrigger (Microsoft.Dynamics.Commerce.Runtime.Localization.Services.dll)
- Microsoft.Dynamics.Commerce.Runtime.Localization.Services.Italy.TaxRegistrationId.Triggers.CreateSalesOrderServiceRequestTrigger (Microsoft.Dynamics.Commerce.Runtime.Localization.Services.dll)
